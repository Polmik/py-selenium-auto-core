...
class LocalizationManager:
    ...
    def __init__(self, logger_configuration: LoggerConfiguration, logger: Logger, root_path: Optional[str] = None):
        ...
        self.__localization_file = self.__get_localization_file(language, root_path or RootPathHelper.executing_root_path())
        self.__core_localization_file = self.__get_localization_file(language, RootPathHelper.executing_root_path())
        self.logger = logger
    ...
    def __get_localization_file(self, language: str, root_path: str) -> dict:
        ...
        root_path_to_use = root_path if FileReader.is_resource_file_exist(resource_name, root_path) else RootPathHelper.executing_root_path()
